...
const char *pci_get_class_name(uint8_t class_code) { return device_classes[class_code]; }
...
const char* mass_storage_controller_subclass_name(uint8_t subclass){
    switch (subclass){
        case 0x00:
...
const char* serial_bus_controller_subclass_name(uint8_t subclass){
    switch (subclass){
        case 0x00:
...
const char* bridge_device_subclass_name(uint8_t subclass){
    switch (subclass){
        case 0x00:
            return "Host Bridge";
        case 0x01:
...
const char *pci_get_subclass_name(uint8_t class_code, uint8_t subclass) {
    switch (class_code){
        case 0x01:
            return mass_storage_controller_subclass_name(subclass);
        case 0x03:
            switch (subclass) {
                case 0x00:
            ...
            return "Unknown";
        case 0x06:
            return bridge_device_subclass_name(subclass);
        case 0x0C:
            return serial_bus_controller_subclass_name(subclass);
    }
    return "Unknown";
}
